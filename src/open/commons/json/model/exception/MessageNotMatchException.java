...
import open.commons.json.model.supports.IMessageCodeProvider;
...
public class MessageNotMatchException extends RuntimeException {
     ...
     */
    public MessageNotMatchException() {
        super();
    }
     ...
     */
    public MessageNotMatchException(String message) {
        super(message);
    }
     ...
     * @since 1.7
     */
    protected MessageNotMatchException(String message, Throwable cause, boolean enableSuppression,
            boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }

    /**
     * Constructs a new runtime exception with the specified cause and a detail message of <tt>(cause==null ? null : cause.toString())</tt> (which typically contains the class and detail message of <tt>cause</tt>). This constructor is useful for
     ...
     * @since 1.4
     */
    public MessageNotMatchException(Throwable cause) {
        super(cause);
    }
}
