...
/**
 * 
 * Throw this when fail to marshal JSONObject, JSONString or JSONArray.
 * 
 * @author Park_Jun_Hong_(fafanmama_at_naver_com)
 * 
 */
public class JSONMarshalledException extends RuntimeException {
     ...
     */
    public JSONMarshalledException() {
        super();
    }
     ...
     *            method.
     */
    public JSONMarshalledException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public JSONMarshalledException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public JSONMarshalledException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected JSONMarshalledException(String message, Throwable cause, boolean enableSuppression,
