...
/**
 * 
 * Throw this when not exist a {@link IMarshaller} for the specific Enum.
 * 
 * @author Park_Jun_Hong_(fafanmama_at_naver_com)
 * 
 */
public class MarshallerNotFoundException extends RuntimeException {
     ...
     * @since 1.4
     */
    public MarshallerNotFoundException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected MarshallerNotFoundException(String message, Throwable cause, boolean enableSuppression,
