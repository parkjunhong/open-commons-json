...
/**
 * 
 * Throw this when a used class instance did not implemented {@link IJSONString}
 * 
 * @author Park_Jun_Hong_(fafanmama_at_naver_com)
 * 
 */
public class IllegalHierarchyException extends RuntimeException {
     ...
     */
    public IllegalHierarchyException() {
        super();
    }
     ...
     *            method.
     */
    public IllegalHierarchyException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public IllegalHierarchyException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public IllegalHierarchyException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected IllegalHierarchyException(String message, Throwable cause, boolean enableSuppression,
