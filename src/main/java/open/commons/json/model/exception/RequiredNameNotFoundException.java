...
/**
 * 
 * Throw this when not exist a name in {@link JSONObject} or JSON string received.
 * 
 * @author Park_Jun_Hong_(parkjunhong77@gmail.com)
 * 
 */
public class RequiredNameNotFoundException extends RuntimeException {
     ...
     */
    public RequiredNameNotFoundException() {
        super();
    }
     ...
     *            method.
     */
    public RequiredNameNotFoundException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public RequiredNameNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public RequiredNameNotFoundException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected RequiredNameNotFoundException(String message, Throwable cause, boolean enableSuppression,
