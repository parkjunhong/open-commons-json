...
/**
 * 
 * Throw this when fail to unmarshal JSONObject, JSONString or JSONArray.
 * 
 * @author Park_Jun_Hong_(parkjunhong77@gmail.com)
 * 
 */
public class JSONUnmarshalledException extends RuntimeException {
     ...
     */
    public JSONUnmarshalledException() {
        super();
    }
     ...
     *            method.
     */
    public JSONUnmarshalledException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public JSONUnmarshalledException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public JSONUnmarshalledException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected JSONUnmarshalledException(String message, Throwable cause, boolean enableSuppression,
