...
/**
 * 
 * Throw this when fails to find a class that implemented the specific interface.
 * 
 * @author Park_Jun_Hong_(fafanmama_at_naver_com)
 * 
 * @see JSONMapper
...
public class ImplClassNotFoundException extends RuntimeException {
     ...
     */
    public ImplClassNotFoundException(String message) {
        super(message);
    }
     ...
     * @since 1.7
     */
    protected ImplClassNotFoundException(String message, Throwable cause, boolean enableSuppression,
     ...
     * @since 1.4
     */
    public ImplClassNotFoundException(Throwable cause) {
        super(cause);
    }
}
