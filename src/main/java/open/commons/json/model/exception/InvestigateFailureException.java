...
/**
 * 
 * Throw this when fail to investigate a field of a instance.
 * 
 * @author Park_Jun_Hong_(parkjunhong77@gmail.com)
 * 
 */
public class InvestigateFailureException extends RuntimeException {
     ...
     */
    public InvestigateFailureException() {
        super();
    }
     ...
     *            method.
     */
    public InvestigateFailureException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public InvestigateFailureException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public InvestigateFailureException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected InvestigateFailureException(String message, Throwable cause, boolean enableSuppression,
