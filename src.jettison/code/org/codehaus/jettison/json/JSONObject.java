 ...
 */
package code.org.codehaus.jettison.json;
...
import code.org.codehaus.jettison.JSONSequenceTooLargeException;
...
public class JSONObject implements Serializable {
        ...
        for (;;) {
            ...
            switch (nextClean) {
                ...
                case '}':
                    return;
                default:
                    throw x.syntaxError("Expected a ',' or '}'. but '" + nextClean + "' has come!!! ");
            }
        }
    }
    ...
    private long doGetLong(String key, Object o) throws JSONException {
        return o instanceof String ? Long.parseLong(((String) o)) : o instanceof Number ? ((Number) o).longValue() : (long) getDouble(key);
    }
    ...
    String toString(int indentFactor, int indent) throws JSONException {
        ...
        if (n == 1) {
            ...
            sb.append(quote(o.toString(), escapeForwardSlashAlways));
            sb.append(": ");
            sb.append(valueToString(this.myHashMap.get(o), indentFactor, indent, escapeForwardSlashAlways));
        } else {
            while (keys.hasNext()) {
                o = keys.next();
                if (sb.length() > 1) {
                ...
                sb.append(": ");
                sb.append(valueToString(this.myHashMap.get(o), indentFactor, newindent, escapeForwardSlashAlways));
            }
            if (sb.length() > 1) {
                sb.append('\n');
    ...
    public Writer write(Writer writer) throws JSONException {
        try {
            ...
            if (hashMapSize == 1) {
                dropObjectKeyName = dropRootElement || ignoredElements != null && ignoredElements.contains(keys().next());
            }
            ...
            while (keys.hasNext()) {
                ...
                if (!dropObjectKeyName) {
                    mayBeDropSimpleElement = hashMapSize > 1 && ignoredElements != null && ignoredElements.contains(k);
        ...
        for (i = 0; i < len; i += 1) {
            ...
            switch (c) {
                ...
                case '"':
                    ...
                    break;
                case '/':
                    // JSONArray.join(String) bug fix.....?............. (x.x)...
