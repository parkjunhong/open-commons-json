...
public class JSONArray implements Serializable {
    ...
    String toString(int indentFactor, int indent) throws JSONException {
        ...
        StringBuilder sb = new StringBuilder("[");
        if (len == 1) {
            sb.append(JSONObject.valueToString(this.myArrayList.get(0), indentFactor, indent, true));
        } else {
            ...
            for (i = 0; i < len; i += 1) {
                ...
                sb.append(JSONObject.valueToString(this.myArrayList.get(i), indentFactor, newindent, true));
            }
            sb.append('\n');
